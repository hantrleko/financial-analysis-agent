...
I18N = {
    ...
    "chart_technical": {"en": "Technical Analysis", "zh": "技术分析"},
    "tech_indicators": {"en": "📈 Technical Indicators", "zh": "📈 技术指标"},
    "tech_pick_asset": {"en": "Select an asset for technical analysis", "zh": "选择一个资产进行技术分析"},
    "tech_show_bollinger": {"en": "Bollinger Bands", "zh": "布林带"},
    "tech_show_rsi": {"en": "RSI", "zh": "RSI"},
    "tech_show_macd": {"en": "MACD", "zh": "MACD"},
    "tech_summary": {"en": "Indicator Summary", "zh": "指标摘要"},
    "tech_signal_col": {"en": "Reading", "zh": "读数"},
    "tech_score_label": {"en": "Technical Score", "zh": "技术面综合分"},
    "tech_no_signal": {"en": "No strong technical signals detected.", "zh": "未检测到明显的技术信号。"},
    # Watchlist
    "tab_watchlist": {"en": "⭐ Watchlist", "zh": "⭐ 自选"},
    "watchlist_title": {"en": "⭐ My Watchlist", "zh": "⭐ 我的自选"},
    "watchlist_caption": {
        "en": "Track custom tickers with live quotes and technical signals. Data persists locally.",
        "zh": "追踪自定义标的的实时报价与技术信号，数据本地保存。",
    },
    "watchlist_add": {"en": "Add ticker (e.g. AAPL, MSFT, 600519.SS)", "zh": "添加标的（如 AAPL、MSFT、600519.SS）"},
    "watchlist_add_btn": {"en": "➕ Add", "zh": "➕ 添加"},
    "watchlist_empty": {"en": "Your watchlist is empty. Add a ticker above to begin.", "zh": "自选列表为空，请在上方添加标的。"},
    "watchlist_added": {"en": "Added {ticker} to watchlist.", "zh": "已将 {ticker} 加入自选。"},
    "watchlist_exists": {"en": "{ticker} is already in your watchlist.", "zh": "{ticker} 已在自选中。"},
    "watchlist_invalid": {"en": "Could not fetch data for {ticker}. Check the symbol.", "zh": "无法获取 {ticker} 的数据，请检查代码。"},
    "watchlist_remove": {"en": "Remove", "zh": "移除"},
    "watchlist_refresh": {"en": "🔄 Refresh Quotes", "zh": "🔄 刷新报价"},
    "watchlist_col_ticker": {"en": "Ticker", "zh": "代码"},
    "watchlist_col_price": {"en": "Price", "zh": "价格"},
    "watchlist_col_change": {"en": "Change %", "zh": "涨跌%"},
    "watchlist_col_rsi": {"en": "RSI", "zh": "RSI"},
    "watchlist_col_signal": {"en": "Tech Signal", "zh": "技术信号"},
    "watchlist_loading": {"en": "Fetching watchlist quotes...", "zh": "正在获取自选报价..."},
